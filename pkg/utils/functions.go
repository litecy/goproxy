...
import (
	...
	"errors"
	"fmt"
	"github.com/litecy/goproxy/pkg/utils/id"
	lb2 "github.com/litecy/goproxy/pkg/utils/lb"
	"io"
	"io/ioutil"
	logger "log"
	"math/rand"
...
func LBMethod(key string) int {
	typs := map[string]int{"weight": lb2.SELECT_WEITHT, "leasttime": lb2.SELECT_LEASTTIME, "leastconn": lb2.SELECT_LEASTCONN, "hash": lb2.SELECT_HASH, "roundrobin": lb2.SELECT_ROUNDROBIN}
	return typs[key]
}
