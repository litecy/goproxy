...
import (
	"fmt"
	buf2 "github.com/litecy/goproxy/pkg/core/lib/buf"
	mapx2 "github.com/litecy/goproxy/pkg/core/lib/mapx"
	logger "log"
	"net"
	"runtime/debug"
	"strings"
...
func NewIOBinder(listener *net.UDPConn, log *logger.Logger) *IOBinder {
	return &IOBinder{
		listener: listener,
		outConns: mapx2.NewConcurrentMap(),
		log:      log,
	}
}
