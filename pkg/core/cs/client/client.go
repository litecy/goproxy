...
import (
	...
	"errors"
	"fmt"
	dst2 "github.com/litecy/goproxy/pkg/core/dst"
...
func KCPConnectHost(hostAndPort string, config kcpcfg2.KCPConfigArgs) (conn net.Conn, err error) {
	...
	return transport.NewCompStream(kcpconn), err
}
